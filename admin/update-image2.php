...
if(isset($_POST['submit']))
{
	...
	if (move_uploaded_file($_FILES["productimage2"]["tmp_name"], $uploadDir . "/" . $_FILES["productimage2"]["name"])) {
...
<div class="controls">
<?php 
$imagePath = "productimages/" . htmlentities($pid) . "/" . htmlentities($row['productImage2']);
$fullImagePath = __DIR__ . "/" . $imagePath;
if (file_exists($fullImagePath) && !empty($row['productImage2'])) {
