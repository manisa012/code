...
if(!is_dir($dir)){
    mkdir("productimages/".$productid, 0755, true);
}

// Upload images to the product directory
if (move_uploaded_file($_FILES["productimage1"]["tmp_name"],"productimages/$productid/".$imgnewfile1) &&
    move_uploaded_file($_FILES["productimage2"]["tmp_name"],"productimages/$productid/".$imgnewfile2) &&
    move_uploaded_file($_FILES["productimage3"]["tmp_name"],"productimages/$productid/".$imgnewfile3)) {
