...
?>										
										...
										<tr>
											...
											<td colspan="3">
												<?php 
												if($row['paymentmethod'] == 'eSewa') {
													echo '<span style="display: flex; align-items: center;"><img src="https://tse3.mm.bing.net/th/id/OIP.fN2-tKH3zajr_XyM520I7wHaE5?rs=1&pid=ImgDetMain&o=7&rm=3" alt="eSewa" style="width: 30px; height: auto; margin-right: 10px; border-radius: 3px;">' . htmlentities($row['paymentmethod']) . ' Digital Wallet</span>';
												} else {
													echo htmlentities($row['paymentmethod']);
												}
												?>
											</td>
										</tr>
										<tr>
											...
											<td colspan="3">
												...
												echo '<span style="color: ' . $status_color . '; font-weight: bold;">' . htmlentities($status) . '</span>';
												?>
											</td>
										</tr>
										<?php if($row['transactionid']): ?>
										<tr>
											<th>Transaction ID</th>
											<td colspan="3">
												<code><?php echo htmlentities($row['transactionid']); ?></code>
											</td>
										</tr>
										<?php endif; ?>
