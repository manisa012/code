...
<div class="controls">
<?php 
$imagePath1 = "productimages/" . htmlentities($pid) . "/" . htmlentities($row['productImage1']);
$fullImagePath1 = __DIR__ . "/" . $imagePath1;
if (file_exists($fullImagePath1) && !empty($row['productImage1'])) {
    echo '<img src="' . $imagePath1 . '" width="200" height="100" alt="Product Image 1">';
} else {
    ...
    echo '<small>Path: ' . $imagePath1 . '</small>';
    echo '</div>';
}
...
<div class="controls">
<?php 
$imagePath2 = "productimages/" . htmlentities($pid) . "/" . htmlentities($row['productImage2']);
$fullImagePath2 = __DIR__ . "/" . $imagePath2;
if (file_exists($fullImagePath2) && !empty($row['productImage2'])) {
    echo '<img src="' . $imagePath2 . '" width="200" height="100" alt="Product Image 2">';
} else {
    echo '<div style="width:200px; height:100px; background-color:#f0f0f0; border:1px solid #ccc; display:flex; align-items:center; justify-content:center; color:#666;">';
    echo 'Image not found<br>';
    echo '<small>Path: ' . $imagePath2 . '</small>';
    echo '</div>';
}
...
<div class="controls">
<?php 
$imagePath3 = "productimages/" . htmlentities($pid) . "/" . htmlentities($row['productImage3']);
$fullImagePath3 = __DIR__ . "/" . $imagePath3;
if (file_exists($fullImagePath3) && !empty($row['productImage3'])) {
    echo '<img src="' . $imagePath3 . '" width="200" height="100" alt="Product Image 3">';
} else {
    echo '<div style="width:200px; height:100px; background-color:#f0f0f0; border:1px solid #ccc; display:flex; align-items:center; justify-content:center; color:#666;">';
    echo 'Image not found<br>';
    echo '<small>Path: ' . $imagePath3 . '</small>';
    echo '</div>';
}
